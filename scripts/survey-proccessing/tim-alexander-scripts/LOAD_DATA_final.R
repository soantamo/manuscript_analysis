...
save(lac, lake_info, species_info, fish_data, actions, file = "PLDB_final_03052022.Rdata")
...
lakes_with_t <- c("Biel", "Brienz", "Constance", "Geneva", "Hallwil", "Joux", "Lucerne",
                  "Lugano", "Maggiore", "Neuchatel", "Poschiavo", 
                  "Sarnen", "Sils", "Thun", "Walen", "Zug", "Zurich")

# filter the lakes that also have temperature data
lac_filter_t <- lac_concise %>% 
  filter(Lake %in% lakes_with_t)

# save the smaller version of the dataset with filtered lakes
saveRDS(lac_filter_t, file = "PLDB_final_short_03052022.RDS")
